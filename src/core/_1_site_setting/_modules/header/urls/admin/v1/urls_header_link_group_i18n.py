...
urlpatterns = [
    path(
        ...
        name="admin-v1-setting-header-group-add",
    ),
    path(
        "delete/",
        vv.HeaderLinkGroupDeleteView.as_view(),
        name="admin-v1-setting-header-group-delete",
    ),
    path(
        "edit/<pk>/",
        vv.HeaderLinkGroupEditView.as_view(),
        name="admin-v1-setting-header-group-edit",
    ),
    path(
        "<pk>/",
        vv.HeaderLinkGroupDetailView.as_view(),
        name="admin-v1-setting-header-group-detail",
    ),
    path(
        "",
        vv.HeaderLinkGroupListView.as_view(),
        name="admin-v1-setting-header-group-list",
    ),
]
