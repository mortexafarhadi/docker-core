...
from ___utils.functions.string_function import random_string
from ___utils.service.email_service import send_mail
from ___utils.views.auth_view import check_user_authenticated
...
from _locales import errors_en
    ...
    def get(self, request):
        ...
        if _redirect is not None:
            ...
            if _USE_ALLAUTH_SERVICE:
                return render(request, "_auth/v1/register_with_allauth.html", context)
            else:
                return render(request, "_auth/v1/register.html", context)
...
class LoginView(View):
    def get(self, request):
        ...
        if _redirect is not None:
            ...
            context = site_setting_context(context)
            if _USE_ALLAUTH_SERVICE:
                return render(request, "_auth/v1/login_with_allauth.html", context)
            else:
                return render(request, "_auth/v1/login.html", context)
        ...
        if _redirect is not None:
            ...
            if form.is_valid():
                ...
                if user is None:
                    ...
                    return render(
                        request,
                        "_auth/v1/error-congratulations.html",
                        context,
                    )
            context = {"form": form}
            context = site_setting_context(context)
