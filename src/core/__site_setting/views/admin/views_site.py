...
class SiteSettingListView(ListView):
    template_name_v1 = "__site_setting/admin/v1/site/site_list.html"
    template_name_v2 = "__site_setting/admin/v2/site/site_list.html"
...
class SiteSettingDetailView(DetailView):
    template_name_v1 = "__site_setting/admin/v1/site/site_detail.html"
    template_name_v2 = "__site_setting/admin/v2/site/site_detail.html"
    model = ms.SiteSetting


class SiteSettingEditView(UpdateView):
    template_name_v1 = "__site_setting/admin/v1/site/site_edit.html"
    template_name_v2 = "__site_setting/admin/v2/site/site_edit.html"
    model = ms.SiteSetting
