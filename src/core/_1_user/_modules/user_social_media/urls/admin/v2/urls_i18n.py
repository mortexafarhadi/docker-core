...
urlpatterns = [
    path(
        ...
        name="admin-v2-user-social-media-add",
    ),
    path(
        "delete/",
        vv.UserSocialMediaDeleteView.as_view(),
        name="admin-v2-user-social-media-delete",
    ),
    path(
        "edit/<pk>/",
        vv.UserSocialMediaEditView.as_view(),
        name="admin-v2-user-social-media-edit",
    ),
    path(
        "<pk>/",
        vv.UserSocialMediaDetailView.as_view(),
        name="admin-v2-user-social-media-detail",
    ),
    path(
        "",
        vv.UserSocialMediaListView.as_view(),
        name="admin-v2-user-social-media-list",
    ),
]
