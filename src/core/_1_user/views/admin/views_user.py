...
class AdminListView(ListView):
    template_name_v1 = "_1_user/admin/v1/user/has_wallet/user_list.html"
    template_name_v2 = "_1_user/admin/v2/user/has_wallet/user_list.html"
    model = User
...
class UserDetailView(DetailView):
    template_name_v1 = "_1_user/admin/v1/user/has_wallet/user_detail.html"
    template_name_v2 = "_1_user/admin/v2/user/has_wallet/user_detail.html"
    model = User
    slug_field = "code"


class UserEditView(UpdateView):
    template_name_v1 = "_1_user/admin/v1/user/has_wallet/user_edit.html"
    template_name_v2 = "_1_user/admin/v2/user/has_wallet/user_edit.html"
    model = User
