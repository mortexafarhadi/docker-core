...
#
# from ___utils.functions.json import read_json
#
# NETWORKS_FILE = "___utils/service/crypto/utils/metadata/networks.json"
...
#
# from ___utils.base_variables import SMART_CONTRACT_OWNER_PK
#
#
