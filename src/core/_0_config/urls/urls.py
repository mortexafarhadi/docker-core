...
i18n_paths = [
    path("v1/auth/", include("_2_auth.urls.v1.urls")),
    path("v2/auth/", include("_2_auth.urls.v2.urls")),
]
...
if USE_PANEL_ADMIN_CUSTOM:
    i18n_paths += [
        ...
        path("v1/panel-admin/", include("_2_panel_admin.urls.admin.v1.urls_i18n")),
        path("v2/panel-admin/", include("_2_panel_admin.urls.admin.v2.urls_i18n")),
    ]
...
if USE_PANEL_USER:
    i18n_paths += [
        ...
        path("v1/user/", include("_2_panel_user.urls.panel_user.v1.urls_i18n")),
        path("v2/user/", include("_2_panel_user.urls.panel_user.v2.urls_i18n")),
    ]
