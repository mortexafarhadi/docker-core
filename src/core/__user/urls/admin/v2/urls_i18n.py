...
from __user.views.admin import views_base as vb
from __user.views.admin import views_user as vv
...
urlpatterns = [
    ...
    path(
        "social-media/",
        include("__user._modules.user_social_media.urls.admin.v2.urls_i18n"),
    ),
    path(
        "register/",
